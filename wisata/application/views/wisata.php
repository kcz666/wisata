                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center">
                                ...
                                <span class="badge badge-danger"><?= $ws['lokasi'] ?></span>
                                <!-- Product price-->
                            </div>
                            <br>
                            <b>
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center">
                                <a id="setdetail" class="btn btn-outline-dark btn text-dark mt-auto" data-toggle="modal" data-target="#exampleModal" data-tempat="<?= $ws['nama_tempat'] ?>" data-foto="<?= $ws['foto'] ?>" data-deskripsi="<?= $ws['deskripsi'] ?>" data-embed="<?= $ws['embed'] ?>">Info</a>
                                <a id="pesanwisata" class="btn btn-outline-dark btn-primary text-white mt-auto" data-toggle="modal" data-target="#pesan" data-chooseidwisata="<?= $ws['wisata_id'] ?>" data-choosewisata="<?= $ws['nama_tempat'] ?>" data-choosetiketdewasa="<?= $ws['tiket_dewasa'] ?>">Pesan</a>
                            </div>
                        </div>
                    </div>
                </div>
